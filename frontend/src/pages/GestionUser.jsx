    ...
    <>
      <div className="flex h-screen overflow-hidden">
        ...
        <div className="w-full flex flex-col">
          ...
          <div
            className={`w-full p-10 ml-0 mt-20 col-span-10 bg-white dark:bg-gray-800 overflow-y-auto`}
          >
            <PanelUsuario />
            {auth?.tipo_usuario === "Admin_Gnl" ? (
              <button
                onClick={() => setMostrarModal(true)}
                className="bg-blue-600 w-50 text-white py-2 px-4 ml-5 rounded-md hover:bg-blue-800 transition duration-200 dark:bg-blue-700 dark:hover:bg-blue-900"
              >
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            ...
            <motion.button
              ...
              <div className="mb-4">
                ...
                >
                  Token de acceso válido por 4 horas
                </label>
                <input
                  type="text"
                  id="token"
