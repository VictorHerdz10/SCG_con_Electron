...
const SupplementModal = ({ contratoSeleccionado, tipoContrato }) => {
  const [selectedContractForSupplement, setSelectedContractForSupplement] =
    useState(contratoSeleccionado);
